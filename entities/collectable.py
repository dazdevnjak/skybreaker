...
class Collectable:
    ...
    def Update_all(delta_time,player_one,player_two,screen):
        for collectable in Collectable.instances[:]:
            ...
            if Collectable.Check_collision(collectable,collectable_rect,player_one,player_two):
